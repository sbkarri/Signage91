...
import com.app.signage91.componentfragments.ComponentFragment
...
import com.app.signage91.samplefragment.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            if (videoPlayerType == COMPONENT_TYPE.EXO_PLAYER) {
                ...
                supportFragmentManager.beginTransaction()
                    .add(R.id.container, ComponentFragment.newInstance(JSONObject())).commit()
            }
